...
public class EnrollmentController {
    ...
    public ResponseEntity<Enrollment> getEnrollment(@PathVariable Long enrollmentId,
        ...
        // Only the owner of the enrollment or an admin can view it
    ...
    /**
     * Helper method: check if current user has a specific role
     */
    ...
    /**
     * Helper method: get the role of the current user
     */
